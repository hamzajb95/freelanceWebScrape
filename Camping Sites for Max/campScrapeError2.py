...
def main():  
  path = r'C:\\Users\Hamza JB\Documents\Python\Camping Sites for Max\errorList2.txt'
  urlx = file_read(path)
...
def writeRecords(cList):  
  with open(r'C:\\Users\Hamza JB\Documents\Python\Camping Sites for Max\CampsitesError.csv','ab') as fw:
